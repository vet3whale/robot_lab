...
from .rough_env_cfg import UnitreeB2WPositionRoughEnvCfg
...
@configclass
class UnitreeB2WPositionStaircaseUpEnvCfg(UnitreeB2WPositionRoughEnvCfg):
    def __post_init__(self):
        ...
        # (position tracking weights are set in the B2W position base; no per-task change needed here)
        ...
        if self.__class__.__name__ == "UnitreeB2WPositionStaircaseUpEnvCfg":
